...
Urine_Raw_Corrected <- readxl::read_excel( path = 'Urine samples thermograms raw 4.23.2023 corrected.xlsx',sheet='Data')
...
save.image('Urine_Working.RData') ### This should only be run once

load('Urine_Working.RData')
...
#save.image('ACF_Detect.RData')

load('ACF_Detect.RData')
